...
_LESSON_DRAFT = {
    ...
    "blocks": [
        {
            "type": "demonstration",
            "title": "Model escape options",
            "minutes": 8,
            "purpose": "Show move, block, and capture responses.",
            "teacher_action": "Set up one checked king and name the three legal escape options.",
            "learner_action": "Point to a move, a block, and a capture idea.",
            "check_for": "Learner can name one legal escape option.",
        },
        {
            "type": "guided_practice",
            "title": "Try escape positions",
            "minutes": 7,
            "purpose": "Practice choosing legal responses.",
            "teacher_action": "Offer one position at a time and ask for the safest response.",
            "learner_action": "Choose a legal move and explain the idea.",
            "check_for": "Learner avoids illegal king moves.",
        },
        {
            "type": "check_for_understanding",
            "title": "Exit position",
            "minutes": 3,
            "purpose": "Confirm the learner can solve one checked position.",
            "teacher_action": "Show one final position and ask for the escape move.",
            "learner_action": "Select and name the response.",
            "check_for": "Learner solves the final position.",
        },
    ],
    "materials": [],
    "teacher_notes": [],
