...
_LESSON_DRAFT = {
    ...
    "blocks": [
        {
            "type": "model",
            "title": "Model the focus",
            "minutes": 12,
            "purpose": "Introduce the lesson focus.",
            "teacher_action": "Explain the focus with one concrete example.",
            "learner_action": "Listen and restate the example.",
            "check_for": "Learner can restate the focus.",
        },
        {
            "type": "guided_practice",
            "title": "Practice the focus",
            "minutes": 14,
            "purpose": "Try the lesson focus with support.",
            "teacher_action": "Prompt the learner through one practice item.",
            "learner_action": "Complete the practice item aloud.",
            "check_for": "Learner completes the item with support.",
        },
        {
            "type": "check_for_understanding",
            "title": "Exit check",
            "minutes": 4,
            "purpose": "Confirm readiness to stop.",
            "teacher_action": "Ask one final check question.",
            "learner_action": "Answer the final question.",
            "check_for": "Learner gives a relevant answer.",
        },
    ],
    "materials": [],
    "teacher_notes": [],
