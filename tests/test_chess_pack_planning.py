    ...
    return ActivityGenerationInput.model_validate(
        {
            ...
            "lesson_draft": {
                ...
                "blocks": [
                    {
                        "type": "demonstration",
                        "title": "Model legal escapes",
                        "minutes": 12,
                        "purpose": "Show move, block, and capture responses to check.",
                        "teacher_action": "Set up a checked king and compare the three legal response types.",
                        "learner_action": "Identify which response type each example uses.",
                        "check_for": "Learner distinguishes move, block, and capture.",
                    },
                    {
                        "type": "guided_practice",
                        "title": "Solve escape examples",
                        "minutes": 14,
                        "purpose": "Practice selecting legal escape moves.",
                        "teacher_action": "Present positions and ask for a safe response.",
                        "learner_action": "Choose a legal move and explain why it escapes check.",
                        "check_for": "Learner rejects moves that leave the king in check.",
                    },
                    {
                        "type": "check_for_understanding",
                        "title": "Final checked position",
                        "minutes": 4,
                        "purpose": "Confirm the learner can solve one position independently.",
                        "teacher_action": "Give one final position without coaching.",
                        "learner_action": "Select the legal escape response.",
                        "check_for": "Learner chooses a legal response.",
                    },
                ],
                "materials": [],
                "teacher_notes": [],
    ...
    payload = ActivityGenerationInput.model_validate(
        {
            ...
            "lesson_draft": {
                ...
                "blocks": [
                    {
                        "type": "model",
                        "title": "Model one feature",
                        "minutes": 8,
                        "purpose": "Show how to describe a daily-life feature.",
                        "teacher_action": "Name one feature and model a short description.",
                        "learner_action": "Listen and repeat the feature in their own words.",
                        "check_for": "Learner names one accurate feature.",
                    },
                    {
                        "type": "guided_practice",
                        "title": "Describe another feature",
                        "minutes": 8,
                        "purpose": "Practice describing a second feature.",
                        "teacher_action": "Prompt the learner with one image or fact.",
                        "learner_action": "Describe the feature using a complete sentence.",
                        "check_for": "Learner gives one clear description.",
                    },
                    {
                        "type": "check_for_understanding",
                        "title": "Exit description",
                        "minutes": 4,
                        "purpose": "Confirm the learner can name and describe one feature.",
                        "teacher_action": "Ask for one final feature from memory.",
                        "learner_action": "State one feature and why it mattered.",
                        "check_for": "Learner gives a relevant feature.",
                    },
                ],
                "materials": [],
                "teacher_notes": [],
